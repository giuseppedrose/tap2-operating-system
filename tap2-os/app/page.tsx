...
import {
  DollarSign, Users, GitBranch, Wallet, Cpu, TrendingUp,
  TrendingDown, ArrowUp, ArrowDown, Minus,
} from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">December 2025 — All key metrics at a glance</p>
        </div>
